...
func newCreateCmd(deps *commands.Deps) *cobra.Command {
	...
	cmd.Flags().String("smart-region", "", `smart scheduling: preferred region, e.g. "Europe", "America", "Asia"`)
	cmd.Flags().String("smart-regions", "", `smart scheduling: allowed regions as JSON, e.g. ["Europe","America"]`)
